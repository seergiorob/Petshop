...
// const tableContainer = document.getElementById("items")
...
// //     toDisplayFavorite.push(
// //       ...artiEnArray.filter((art) => art._id == idguardado)
// //     );
// //   });
...
// //                                       </div>
// //                                   </td>
// //                                   <td><button class="restasumx" onClick="restQ('${
// //                                     articulo._id
// //                                   }')">-</button></td>
...
// //                                   <td><button class="restasumx" onClick="addQ('${
// //                                     articulo._id
// //                                   }')">+</button></td>
// //                                   <td><button class="restasumx" onClick="removeID('${
// //                                     articulo._id
// //                                   }')"> x </button></td>
// //                               </tr>
// //                               `;
...
// //   counter = [];
// //   counter.push(
// //     ...toDisplayFavorite.filter((articulos) => articulos._id == event)
// //   );
...
// //     ...toDisplayFavorite.filter((articulos) => articulos._id == event)
// //   );
// //   counter.map((articulos) =>
// //     articulos.cantidad > 0 ? articulos.cantidad-- : articulos.cantidad
// //   );
